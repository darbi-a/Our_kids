...
//                }, 1000);
    ...
    models.Product = models.Product.extend({
        ...
        get_price_list_discount: function(pricelist,quantity){
            var price_from_price_list = this.get_price(pricelist,quantity);
            var normal_price = this.lst_price;
            var discount = Math.round((normal_price - price_from_price_list)/normal_price * 10000)/100;
            return discount;
        }
    })
