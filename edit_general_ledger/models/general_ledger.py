    ...
    def _get_lines(self, options, line_id=None):
            ...
            if offset == 0:
                lines.append({
                    ...
                    'columns': [{'name': v} for v in
                                [amount_currency, self.format_value(pdebit), self.format_value(pcredit), self.format_value(debit), self.format_value(credit),
        ...
        if not line_id:
            lines.append({
                ...
                'level': 1,
                'columns': [{'name': v} for v in
                            ['', '', '', '',self.format_value(sum_pdebit),self.format_value(sum_pcredit), self.format_value(sum_debit), self.format_value(sum_credit),
